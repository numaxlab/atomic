...
function Jn(e) {
  let t = L.indexOf(e);
  t !== -1 && t > Pe && L.splice(t, 1);
}
function Vn() {
  !Ie && !$e && ($e = !0, queueMicrotask(Yn));
}
function Yn() {
  $e = !1, Ie = !0;
  for (let e = 0; e < L.length; e++)
    L[e](), Pe = e;
  L.length = 0, Pe = -1, Ie = !1;
}
var q, B, W, Tt, Re = !0;
function Gn(e) {
  Re = !1, e(), Re = !0;
...
function Xn(e) {
  q = e.reactive, W = e.release, B = (t) => e.effect(t, { scheduler: (n) => {
    Re ? Wn(n) : n();
  } }), Tt = e.raw;
}
function ht(e) {
...
function er(e) {
  var t, n;
  for ((t = e._x_effects) == null || t.forEach(Jn); (n = e._x_cleanups) != null && n.length; )
    e._x_cleanups.pop()();
}
var Ve = new MutationObserver(Ze), Ye = !1;
function Ge() {
...
function Ze(e) {
  ...
  for (let o of n)
    t.some((s) => s.contains(o)) || Pt.forEach((s) => s(o));
  for (let o of t)
    o.isConnected && Rt.forEach((s) => s(o));
...
var ir = {
  ...
  get({ objects: e }, t, n) {
    return t == "toJSON" ? or : Reflect.get(
      e.find(
        (r) => Reflect.has(r, t)
      ) || {},
      t,
...
function Bt(e, t = () => {
  ...
  let n = {
    ...
    _x_interceptor: !0,
    initialize(r, i, o) {
      return e(this.initialValue, () => sr(r, i), (s) => je(r, i, s), i, o);
    }
  };
  return t(n), (r) => {
...
function Le(e, t) {
  let n = ar(t);
  return Object.entries(Kt).forEach(([r, i]) => {
...
function ar(e) {
  let [t, n] = Jt(e), r = { interceptor: Bt, ...t };
  return Je(e, n), r;
}
function ur(e, t, n, ...r) {
  try {
...
function qt(e, t) {
  let n = {};
  Le(n, e);
  let r = [n, ...z(e)], i = typeof t == "function" ? lr(r, t) : dr(r, t, e);
...
function dr(e, t, n) {
  ...
  return (i = () => {
    ...
    if (typeof r == "function") {
      ...
      r.finished ? (he(i, r.result, a, s, n), r.result = void 0) : u.then((c) => {
        he(i, c, a, s, n);
      }).catch((c) => ne(c, n, t)).finally(() => r.result = void 0);
    }
  };
}
...
function et(e, t, n) {
  if (t = Array.from(t), e._x_virtualDirectives) {
    let o = Object.entries(e._x_virtualDirectives).map(([a, u]) => ({ name: a, value: u })), s = Wt(o);
  ...
  let r = {};
  return t.map(Gt((o, s) => r[o] = s)).filter(Zt).map(xr(r, n)).sort(yr).map((o) => gr(e, o));
}
function Wt(e) {
  return Array.from(e).map(Gt()).filter((t) => !Zt(t));
}
var Ne = !1, Q = /* @__PURE__ */ new Map(), Ut = Symbol();
function hr(e) {
  Ne = !0;
  let t = Symbol();
  Ut = t, Q.set(t, []);
...
function gr(e, t) {
  let n = () => {
  }, r = ge[t.type] || n, [i, o] = Jt(e);
  Lt(e, t.original, o);
  let s = () => {
    e._x_ignore || e._x_ignoreSelf || (r.inline && r.inline(e, t, i), r = r.bind(r, e, t, i), Ne ? Q.get(Ut).push(r) : r());
  };
  return s.runCleanups = o, s;
}
var Vt = (e, t) => ({ name: n, value: r }) => (n.startsWith(e) && (n = n.replace(e, t)), { name: n, value: r }), Yt = (e) => e;
function Gt(e = () => {
}) {
...
function xr(e, t) {
  return ({ name: n, value: r }) => {
    let i = n.match(Qt()), o = n.match(/:([a-zA-Z0-9\-_:]+)/), s = n.match(/\.[^.\]]+(?=[^\]]*$)/g) || [], a = t || e[n] || n;
    return {
      type: i ? i[1] : null,
      value: o ? o[1] : null,
...
function yr(e, t) {
  let n = j.indexOf(e.type) === -1 ? Fe : e.type, r = j.indexOf(t.type) === -1 ? Fe : t.type;
...
function br() {
  ...
  Array.from(document.querySelectorAll(nn().join(","))).filter(e).forEach((t) => {
    C(t);
  }), ee(document, "alpine:initialized"), setTimeout(() => {
    Er();
  });
}
var nt = [], en = [];
...
function C(e, t = D, n = () => {
  ...
  J(e, (r) => r._x_ignore) || hr(() => {
    t(e, (r, i) => {
      r._x_marker || (n(r, i), sn.forEach((o) => o(r, i)), et(r, r.attributes).forEach((o) => o()), r._x_ignore || (r._x_marker = wr++), r._x_ignore && i());
    });
  });
}
function V(e, t = D) {
  t(e, (n) => {
    er(n), Nt(n), delete n._x_marker;
  });
}
function Er() {
  [
...
function ot(e, t) {
  return Array.isArray(t) ? xt(e, t.join(" ")) : typeof t == "object" && t !== null ? Sr(e, t) : typeof t == "function" ? ot(e, t()) : xt(e, t);
}
function xt(e, t) {
...
y("transition", (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
  typeof r == "function" && (r = i(r)), r !== !1 && (!r || typeof r == "boolean" ? $r(e, n, t) : Tr(e, r, t));
});
function Tr(e, t, n) {
  an(e, ot, ""), {
    enter: (i) => {
...
function $r(e, t, n) {
  ...
  t.includes("in") && !r && (t = t.filter((h, x) => x < t.indexOf("out"))), t.includes("out") && !r && (t = t.filter((h, x) => x > t.indexOf("out")));
  let s = !t.includes("opacity") && !t.includes("scale"), a = s || t.includes("opacity"), u = s || t.includes("scale"), c = a ? 0 : 1, l = u ? X(t, "scale", 95) / 100 : 1, d = X(t, "delay", 0) / 1e3, p = X(t, "origin", "center"), b = "opacity, transform", M = X(t, "duration", 150) / 1e3, se = X(t, "duration", 75) / 1e3, f = "cubic-bezier(0.4, 0.0, 0.2, 1)";
...
var ze = !1;
function jr(e, t) {
  t._x_dataStack || (t._x_dataStack = e._x_dataStack), $ = !0, ze = !0, ln(() => {
    Lr(t);
  }), $ = !1, ze = !1;
}
function Lr(e) {
...
function fn(e, t, n, r = []) {
  switch (e._x_bindings || (e._x_bindings = q({})), e._x_bindings[t] = n, t = r.includes("camel") ? Hr(t) : t, t) {
    case "value":
      Nr(e, n);
      break;
    case "style":
...
function Nr(e, t) {
  if (hn(e))
    e.attributes.value === void 0 && (e.value = t), window.fromModel && (typeof t == "boolean" ? e.checked = pe(e.value) === t : e.checked = yt(e.value, t));
  else if (st(e))
...
function Jr(e, t, n, r = !0) {
  ...
  if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
    ...
    return i.extract = r, zt(() => N(e, i.expression));
  }
  return _n(e, t, n);
}
function _n(e, t, n) {
...
var R = {}, bt = !1;
function Yr(e, t) {
  if (bt || (R = q(R), bt = !0), t === void 0)
    return R[e];
  R[e] = t, Dt(R[e]), typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && R[e].init();
}
function Gr() {
  return R;
}
...
function Xr(e, t) {
  ...
  return e instanceof Element ? vn(e, n()) : (bn[e] = n, () => {
  });
}
function Zr(e) {
  return Object.entries(bn).forEach(([t, n]) => {
...
var ri = Object.freeze({}), ii = Object.prototype.hasOwnProperty, me = (e, t) => ii.call(e, t), F = Array.isArray, te = (e) => wn(e) === "[object Map]", oi = (e) => typeof e == "string", at = (e) => typeof e == "symbol", we = (e) => e !== null && typeof e == "object", si = Object.prototype.toString, wn = (e) => si.call(e), En = (e) => wn(e).slice(8, -1), ut = (e) => oi(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, ai = (e) => {
  const t = /* @__PURE__ */ Object.create(null);
  return (n) => t[n] || (t[n] = e(n));
}, ui = ai((e) => e.charAt(0).toUpperCase() + e.slice(1)), An = (e, t) => e !== t && (e === e || t === t), He = /* @__PURE__ */ new WeakMap(), Z = [], O, k = Symbol("iterate"), qe = Symbol("Map key iterate");
function ci(e) {
...
var gi = /* @__PURE__ */ ni("__proto__,__v_isRef,__isVue"), Cn = new Set(Object.getOwnPropertyNames(Symbol).map((e) => Symbol[e]).filter(at)), xi = /* @__PURE__ */ Mn(), yi = /* @__PURE__ */ Mn(!0), vt = /* @__PURE__ */ bi();
function bi() {
  const e = {};
...
function Mn(e = !1, t = !1) {
  return function(r, i, o) {
    ...
    if (i === "__v_isReadonly")
      return e;
    if (i === "__v_raw" && o === (e ? t ? Ri : Pn : t ? Pi : In).get(r))
      return r;
    const s = F(r);
    if (!e && s && me(vt, i))
      return Reflect.get(vt, i, o);
    const a = Reflect.get(r, i, o);
    return (at(i) ? Cn.has(i) : gi(i)) || (e || A(r, "get", i), t) ? a : We(a) ? !s || !ut(i) ? a.value : a : we(a) ? e ? Rn(a) : pt(a) : a;
  };
}
var vi = /* @__PURE__ */ mi();
function mi(e = !1) {
  return function(n, r, i, o) {
    let s = n[r];
    if (!e && (i = _(i), s = _(s), !F(n) && We(s) && !We(i)))
      return s.value = i, !0;
    const a = F(n) && ut(r) ? Number(r) < n.length : me(n, r), u = Reflect.set(n, r, i, o);
    return n === _(o) && (a ? An(i, s) && I(n, "set", r, i, s) : I(n, "add", r, i)), u;
  };
}
function wi(e, t) {
...
function Ei(e, t) {
  ...
  return (!at(t) || !Cn.has(t)) && A(e, "has", t), n;
}
function Ai(e) {
...
}, lt = (e) => we(e) ? pt(e) : e, ft = (e) => we(e) ? Rn(e) : e, dt = (e) => e, Ee = (e) => Reflect.getPrototypeOf(e);
function ae(e, t, n = !1, r = !1) {
  e = e.__v_raw;
  const i = _(e), o = _(t);
  t !== o && !n && A(i, "get", t), !n && A(i, "get", o);
  const { has: s } = Ee(i), a = r ? dt : n ? ft : lt;
  if (s.call(i, t))
    return a(e.get(t));
  if (s.call(i, o))
    return a(e.get(o));
...
function ce(e, t = !1) {
  return e = e.__v_raw, !t && A(_(e), "iterate", k), Reflect.get(e, "size", e);
}
function mt(e) {
  e = _(e);
  const t = _(this);
  return Ee(t).has.call(t, e) || (t.add(e), I(t, "add", e, e)), this;
}
function wt(e, t) {
  t = _(t);
  const n = _(this), { has: r, get: i } = Ee(n);
  let o = r.call(n, e);
  o ? $n(n, r, e) : (e = _(e), o = r.call(n, e));
  const s = i.call(n, e);
  return n.set(e, t), o ? An(t, s) && I(n, "set", e, t, s) : I(n, "add", e, t), this;
}
function Et(e) {
  const t = _(this), { has: n, get: r } = Ee(t);
  let i = n.call(t, e);
  i ? $n(t, n, e) : (e = _(e), i = n.call(t, e));
  const o = r ? r.call(t, e) : void 0, s = t.delete(e);
  return i && I(t, "delete", e, void 0, o), s;
}
function At() {
  const e = _(this), t = e.size !== 0, n = te(e) ? new Map(e) : new Set(e), r = e.clear();
  return t && I(e, "clear", void 0, void 0, n), r;
}
function le(e, t) {
  return function(r, i) {
    const o = this, s = o.__v_raw, a = _(s), u = t ? dt : e ? ft : lt;
    return !e && A(a, "iterate", k), s.forEach((c, l) => r.call(i, u(c), u(l), o));
  };
}
function fe(e, t, n) {
  return function(...r) {
    const i = this.__v_raw, o = _(i), s = te(o), a = e === "entries" || e === Symbol.iterator && s, u = e === "keys" && s, c = i[e](...r), l = n ? dt : t ? ft : lt;
    return !t && A(o, "iterate", u ? qe : k), {
      // iterator protocol
      next() {
...
var In = /* @__PURE__ */ new WeakMap(), Pi = /* @__PURE__ */ new WeakMap(), Pn = /* @__PURE__ */ new WeakMap(), Ri = /* @__PURE__ */ new WeakMap();
function ji(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function pt(e) {
  return e && e.__v_isReadonly ? e : jn(e, !1, Si, $i, In);
}
function Rn(e) {
  return jn(e, !0, Oi, Ii, Pn);
}
...
S("data", (e) => kt(e));
S("root", (e) => ye(e));
S("refs", (e) => (e._x_refs_proxy || (e._x_refs_proxy = ie(Ni(e))), e._x_refs_proxy));
function Ni(e) {
  let t = [];
  return J(e, (n) => {
...
function ki(e, t) {
  e._x_ids || (e._x_ids = {}), e._x_ids[t] || (e._x_ids[t] = Ln(t));
}
S("id", (e, { cleanup: t }) => (n, r = null) => {
  let i = `${n}${r ? `-${r}` : ""}`;
  return Di(e, i, t, () => {
    let o = Fi(e, n), s = o ? o._x_ids[n] : Ln(n);
    return r ? `${n}-${s}-${r}` : `${n}-${s}`;
  });
});
ve((e, t) => {
...
y("modelable", (e, { expression: t }, { effect: n, evaluateLater: r, cleanup: i }) => {
  ...
  u(c), queueMicrotask(() => {
    ...
    let l = e._x_model.get, d = e._x_model.set, p = yn(
      {
        get() {
          return l();
        },
...
y("teleport", (e, { modifiers: t, expression: n }, { cleanup: r }) => {
  ...
  let i = St(n), o = e.content.cloneNode(!0).firstElementChild;
...
function St(e) {
  let t = P(() => document.querySelector(e), () => Bi)();
...
y("ignore", Fn);
y("effect", P((e, { expression: t }, { effect: n }) => {
  n(m(e, t));
}));
function Ue(e, t, n, r) {
  let i = e, o = (u) => r(u), s = {}, a = (u, c) => (l) => c(u, l);
  if (n.includes("dot") && (t = Ki(t)), n.includes("camel") && (t = zi(t)), n.includes("passive") && (s.passive = !0), n.includes("capture") && (s.capture = !0), n.includes("window") && (i = window), n.includes("document") && (i = document), n.includes("debounce")) {
    let u = n[n.indexOf("debounce") + 1] || "invalid-wait", c = xe(u.split("ms")[0]) ? Number(u.split("ms")[0]) : 250;
    o = gn(o, c);
  }
  if (n.includes("throttle")) {
    let u = n[n.indexOf("throttle") + 1] || "invalid-wait", c = xe(u.split("ms")[0]) ? Number(u.split("ms")[0]) : 250;
    o = xn(o, c);
  }
...
function Wi(e, t) {
  ...
  if (n.length === 0 || n.length === 1 && Ot(e.key).includes(n[0]))
    return !1;
  const i = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter((o) => n.includes(o));
  return n = n.filter((o) => !i.includes(o)), !(i.length > 0 && i.filter((s) => ((s === "cmd" || s === "super") && (s = "meta"), e[`${s}Key`])).length === i.length && (kn(e.type) || Ot(e.key).includes(n[0])));
}
function Ot(e) {
  if (!e)
    return [];
...
y("model", (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
  ...
  let u = () => {
    let p;
    return s((b) => p = b), Ct(p) ? p.get() : p;
  }, c = (p) => {
    let b;
    s((M) => b = M), Ct(b) ? b.set(p) : a(() => {
    }, {
  ...
  if (t.includes("fill") && ([void 0, null, ""].includes(u()) || st(e) && Array.isArray(u()) || e.tagName.toLowerCase() === "select" && e.multiple) && c(
    Me(e, t, { target: e }, u())
  ...
  e._x_model = {
    ...
    p === void 0 && typeof n == "string" && n.match(/\./) && (p = ""), window.fromModel = !0, g(() => fn(e, "value", p)), delete window.fromModel;
  }, r(() => {
    let p = u();
...
function Me(e, t, n, r) {
  return g(() => {
    ...
    if (st(e))
      if (Array.isArray(r)) {
        let i = null;
        return t.includes("number") ? i = Te(n.target.value) : t.includes("boolean") ? i = pe(n.target.value) : i = n.target.value, n.target.checked ? r.includes(i) ? r : r.concat([i]) : r.filter((o) => !Ui(o, i));
      } else
      ...
      {
        let i;
        return hn(e) ? n.target.checked ? i = n.target.value : i = r : i = n.target.value, t.includes("number") ? Te(i) : t.includes("boolean") ? pe(i) : t.includes("trim") ? i.trim() : i;
      }
    }
  });
}
...
on(() => `[${U("init")}]`);
y("init", P((e, { expression: t }, { evaluate: n }) => typeof t == "string" ? !!t.trim() && n(t, {}, !1) : n(t, {}, !1)));
...
y("for", (e, { expression: t }, { effect: n, cleanup: r }) => {
  let i = Xi(t), o = m(e, i.items), s = m(
    e,
    // the x-bind:key expression is stored for our use instead of evaluated.
    e._x_keyExpression || "index"
  );
  e._x_prevKeys = [], e._x_lookup = {}, n(() => Gi(e, i, o, s)), r(() => {
  ...
  n((s) => {
    ...
    if (i(s))
      s = Object.entries(s).map(([f, h]) => {
        let x = Mt(t, h, f, s);
        r((v) => {
          l.includes(v) && E("Duplicate key on x-for", e), l.push(v);
    ...
    for (let f = 0; f < l.length; f++) {
      let h = l[f], x = u.indexOf(h);
      if (x === -1)
        u.splice(f, 0, h), d.push([se, f]);
      else if (x !== f) {
        let v = u.splice(f, 1)[0], w = u.splice(x - 1, 1)[0];
        u.splice(f, 0, w), u.splice(x, 0, v), p.push([v, w]);
      } else
        M.push(h);
      se = h;
    }
    ...
    for (let f = 0; f < p.length; f++) {
      let [h, x] = p[f], v = a[h], w = a[x], K = document.createElement("div");
      g(() => {
        w || E('x-for ":key" is undefined or invalid', o, x, a), w.after(K), v.after(w), w._x_currentIfEl && w.after(w._x_currentIfEl), K.before(v), v._x_currentIfEl && v.after(v._x_currentIfEl), K.remove();
      }), w._x_refreshXForScope(c[l.indexOf(x)]);
    }
    for (let f = 0; f < d.length; f++) {
      let [h, x] = d[f], v = h === "template" ? o : a[h];
      v._x_currentIfEl && (v = v._x_currentIfEl);
      let w = c[x], K = l[x], Y = document.importNode(o.content, !0).firstElementChild, _t = q(w);
      re(Y, _t, o), Y._x_refreshXForScope = (zn) => {
        Object.entries(zn).forEach(([Hn, qn]) => {
          _t[Hn] = qn;
        });
      }, g(() => {
        v.after(Y), P(() => C(Y))();
      }), typeof K == "object" && E("x-for key cannot be an object, it must be a string or an integer", o), a[K] = Y;
    }
...
tt(Vt("@", Yt(U("on:"))));
y("on", P((e, { value: t, modifiers: n, expression: r }, { cleanup: i }) => {
  let o = r ? m(e, r) : () => {
  };
...
Ae("Mask", "mask", "mask");
function Ae(e, t, n) {
  y(t, (r) => E(`You can't use [x-${t}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, r));
}
oe.setEvaluator(qt);
...
const eo = () => ({
  toggle() {
    const e = this.$el.getAttribute("aria-expanded") === "true", t = this.$root.querySelector("#" + this.$el.getAttribute("aria-controls")), n = this.$el.querySelector(".accordion-icon");
    if (e ? (t.setAttribute("hidden", !0), this.$el.setAttribute("aria-expanded", !1)) : (t.removeAttribute("hidden"), this.$el.setAttribute("aria-expanded", !0)), n) {
      const r = n.dataset.alt;
      n.dataset.alt = Array.from(n.classList).filter((i) => i !== "accordion-icon").join(" "), n.classList.remove(...Array.from(n.classList).filter((i) => i !== "accordion-icon")), n.classList.add(...r.split(" "));
    }
  }
});
Kn.data("accordion", eo);
Kn.start();
