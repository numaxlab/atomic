...
const collapsible = () => ({
  toggle() {
    ...
    if (!controlsTarget) {
      console.warn("Collapsible component: No target found for aria-controls value.");
      return;
    }
    if (!icon) {
      console.warn('Collapsible component: No icon found with class "collapsible-icon".');
      return;
    }
    if (isExpanded) {
...
module_default.data("carousel", carousel);
module_default.data("collapsible", collapsible);
module_default.data("lineClamp", lineClamp);
